...
Vec_Signal(:, 2) = Delay_Modeling_Var(Signal, 1, p, Delay, N);
Vec_Signal(:, 3) = Delay_Modeling_Var(Signal, 1, p, 2*Delay, N);
Vec_Signal(:, 4) = Delay_Modeling_Var(Signal, 1, p, 3*Delay, N);
